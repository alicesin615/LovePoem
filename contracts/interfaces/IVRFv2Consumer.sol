...
interface IVRFv2Consumer {
	function mintNewPoem(uint256 currPoemPrice, VRFv2Consumer.RequestPurpose _requestPurpose) external payable returns (uint256 requestId);

	function requestRandomWordsFor(VRFv2Consumer.RequestPurpose _requestPurpose) external returns (uint256 requestId);
